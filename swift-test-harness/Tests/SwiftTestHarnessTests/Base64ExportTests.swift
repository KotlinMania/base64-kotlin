...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Base64.swiftmodule/`
...
//      `import Base64` above would fail at compile time.
//
//   2. The static archive `libBase64.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Base64" }` and
//      `flattenPackage = "io.github.kotlinmania.base64"` configuration in
...
final class Base64ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Base64 swift module imported cleanly")
    }
}

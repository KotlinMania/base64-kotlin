...
kotlin {
    ...
    macosArm64 {
        binaries.framework { baseName = "Base64"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Base64"
    ...
    swiftExport {
        moduleName = "Base64"
        flattenPackage = "io.github.kotlinmania.base64"
    }

    android {
        namespace = "io.github.kotlinmania.base64"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "base64-kotlin", version.toString())

    pom {
        name.set("base64-kotlin")
        description.set("Kotlin Multiplatform port of marshallpierce/rust-base64 - encodes and decodes base64 as bytes or utf8")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/base64-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/base64-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/base64-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/base64-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.base64.codeql
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleBase64XCFramework",
    "assembleBase64DebugXCFramework",
    "assembleBase64ReleaseXCFramework",

...
This file is the quick-reference operating contract for base64-kotlin. The longer
...
base64-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`base64`](https://crates.io/crates/base64). Upstream Rust is the behavioral oracle while the
